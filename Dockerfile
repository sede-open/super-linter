...
FROM hadolint/hadolint:v2.15.0-alpine AS dockerfile-lint
...
FROM ghcr.io/clj-kondo/clj-kondo:2026.07.24-alpine AS clj-kondo
...
FROM python:3.15.0b4-alpine3.23 AS python-base
