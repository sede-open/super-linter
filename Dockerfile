...
#########################################
FROM alpine/terragrunt:1.15.9 AS terragrunt
...
FROM golangci/golangci-lint:v2.13.1 AS golangci-lint
...
FROM python:3.15.0rc1-alpine3.23 AS python-base
